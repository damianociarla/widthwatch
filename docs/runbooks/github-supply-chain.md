...
The operation is idempotent. Dependabot proposes verified GitHub Actions SHA updates through pull requests; never replace a full SHA with a mobile major tag.
